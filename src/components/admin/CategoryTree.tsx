...
export default function CategoryTree({ categories, searchTerm, onAction }: CategoryTreeProps) {
  ...
  // Drag and drop state reserved for future implementation
  ...
  const filteredCategories = useMemo(() => filterCategories(categories), [categories, searchTerm, filterCategories]);

  // Drag and drop handlers reserved for future implementation
