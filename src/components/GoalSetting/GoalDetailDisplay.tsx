...
interface GoalDetailDisplayProps {
  detailedGoals: DetailedGoalsResponse | null;
  selectedGoal: string;
  viewMode: ViewMode;
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          {detailedGoals.options?.map((option: GoalDetailOption, index: number) => (
            <div
                ...
                <div className="mt-6 space-y-4">
                  ...
                  {viewMode === 'monthly' && (
                    <div className="border-t pt-4">
                      ...
                      <div className="space-y-3">
                        {option.sixMonthGoals?.map((goal, gIdx: number) => 
                          goal.monthlyPlans?.map((monthPlan, mIdx: number) => (
                  ...
                  {viewMode === 'weekly' && (
                    <div className="border-t pt-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {option.sixMonthGoals?.map((goal) => 
                          goal.monthlyPlans?.map((monthPlan) => 
                            monthPlan.weeklyPlans?.map((weekPlan, wIdx: number) => (
